...
export type InvalidAddRootLifecycleState = ProductError<
  "InvalidAddRootLifecycleState",
  Readonly<{
    targetId: string;
    reason:
      | "target-not-found"
...
export type AddAcceptedTargetRootsInput = Readonly<{
...
function invalidState(
  targetId: string,
  reason: InvalidAddRootLifecycleState["facts"]["reason"]
): Result<never, InvalidAddRootLifecycleState> {
  return {
    ok: false,
    error: productError("InvalidAddRootLifecycleState", {
      targetId,
      reason
    })
  };
